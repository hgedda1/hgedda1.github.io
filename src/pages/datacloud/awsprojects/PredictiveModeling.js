// src/pages/datacloud/awsprojects/PredictiveModeling.js
import React, { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom";
import { motion } from "framer-motion"; // Importing Framer Motion for animations
import ReactMarkdown from "react-markdown";
import PredictiveModelingMarkdown from "../../../files/awsprojects/predictive-modeling.md";
...
export default function PredictiveModeling() {
  ...
  useEffect(() => {
    fetch(PredictiveModelingMarkdown)
