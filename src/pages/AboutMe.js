...
// Importing images
import SecurityPlusLogo from '../assets/images/SecurityPlus Logo.png';
import SecurityPlusLogoWhite from '../assets/images/SecurityPlus Logo White.png';
import SecurityPlusLogoBlack from '../assets/images/SecurityPlus Logo Black.png';

// CompTIA verification URL and code
const compTIAUrl = "https://www.certmetrics.com/comptia/public/verification.aspx/";
const verificationCode = "V0LCPSVZ32V4155Z";
...
export default function AboutMe({ darkMode, toggleDarkMode }) {
  ...
  const handleLogoClick = () => {
    ...
    // Redirect to the CompTIA verification page
    window.open(compTIAUrl, '_blank');
  };
  ...
  const experiences = [
    {
      ...
      description:
        'Leading information security initiatives and implementing robust cybersecurity measures.',
    },
    {
      title: 'TRON Associate',
      company: 'Amazon',
      date: 'Sept 2020 - Oct 2021',
      description:
        "Worked on cutting-edge technologies and contributed to Amazon's technical operations.",
    },
    {
      title: '.NET Developer',
      company: 'FusionIT',
      date: 'Jan 2019 -Feb 2020',
      description: 'Developed and maintained enterprise-level applications using .NET framework.',
    },
    {
      title: 'Unity Developer',
      company: 'Puffy Thumb Game Studio',
      date: 'Dec 2016 - Aug 2017',
      description: 'Created immersive gaming experiences using Unity game engine.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <h3 className="text-xl sm:text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200 blue-line-breathing">
            About Me
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Passionate about information security and cutting-edge technologies. With a diverse
            background in development and security, I bring a unique perspective to solving complex
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            I am a CompTIA Security+ CE SY0-701 certified professional, demonstrating my commitment
            to cybersecurity best practices and industry standards.
          </p>
          <p className="text-gray-600 dark:text-gray-400 mb-4 text-xs">
            Click on the logo to copy the certification code to clipboard and redirect to official verification page
          </p>


          {/* Logo with grayscale to color and zoom effect */}
          <div
            className="logo-container mx-auto mt-8"
            onMouseEnter={() => setHovered(true)}
            onMouseLeave={() => setHovered(false)}
            onClick={handleLogoClick} /* Redirect and copy verification code on click */
            ...
            <motion.img
              src={
                hovered
                  ? SecurityPlusLogo
                  : darkMode
                  ? SecurityPlusLogoWhite
                  : SecurityPlusLogoBlack
              }
