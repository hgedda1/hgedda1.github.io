...
export default function SIEMProject1() {
  ...
  return (
    <motion.div
      ...
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.8 }} // Fade-in animation for page load
    >
      {/* Header Section */}
      <motion.div
        ...
        initial={{ y: "-100vh" }}
        animate={{ y: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }} // Slide down animation for header
      >
      ...
      <motion.div
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.3 }} // Fade-in animation for markdown content
      >
        <ReactMarkdown
      ...
      <motion.div
        ...
        initial={{ y: "100vh" }}
        animate={{ y: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }} // Slide up animation for back button
      >
        <button
