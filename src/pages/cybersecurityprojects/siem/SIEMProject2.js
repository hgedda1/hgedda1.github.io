// src/pages/cybersecurityprojects/siem/SIEMProject2.js
...
import siemMarkdown from "../../../files/siem/siem2.md";

export default function SIEMProject2() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        initial={{ y: "-100vh" }}
        animate={{ y: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }} // Slide-down animation for the header
      >
      ...
      <motion.div
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.3 }} // Fade-in for the markdown content
      >
        <ReactMarkdown
      ...
      <motion.div
        ...
        initial={{ y: "100vh" }}
        animate={{ y: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }} // Slide-up animation for the back button
      >
        <button
