// src/pages/cybersecurityprojects/endpointsecurity/EndpointCompliance.js
import React, { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom";
import ReactMarkdown from "react-markdown";
import endpointComplianceMarkdown from "../../../files/endpointsecurity/endpoint-compliance.md";
...
export default function EndpointCompliance() {
  ...
  useEffect(() => {
    fetch(endpointComplianceMarkdown)
